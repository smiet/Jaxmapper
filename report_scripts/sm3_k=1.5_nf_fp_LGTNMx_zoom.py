...
starts = grid_starting_points(xy_start=(0.4,0.4), xy_end=(0.6,0.6), 
...
# plot.
ax.imshow(colour_grid, origin = 'lower', extent=(0.4, 0.6, 0.4, 0.6))
##################################################################################################################
##################################################################################################################
...
square = Rectangle((0.48, 0.48), 0.04, 0.04, fill = False)
...
ax.set_ylim([0.4,0.6])
# plt.show()
plt.savefig('sm3_k=1.5_nf_fp_LGTNMx_zoom.pdf', bbox_inches='tight', dpi=300)