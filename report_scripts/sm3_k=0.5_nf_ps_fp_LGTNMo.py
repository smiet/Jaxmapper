...
from methods import step_NM, step_LGTNMo, calculate_poincare_section
...
from groundtruth import sm3_fixed_points
unique_fixed_points_array = sm3_fixed_points
...
fixed_point_index_grid = apply_finder_to_grid(map=map3, map_modulo=modulo, 
                                              step=step_LGTNMo, step_modulo=modulo,
...
plt.ylim([0,1])
# plt.show()
plt.savefig('sm3_k=0.5_nf_ps_fp_LGTNMo.png', bbox_inches='tight', dpi=300)