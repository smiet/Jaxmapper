...
from groundtruth import sm2_fixed_points_1
unique_fixed_points_array = sm2_fixed_points_1
...
plt.ylim([0,1])
# plt.show()
plt.savefig('sm2_k=1.0_nf_fp_LGTNMx.pdf', bbox_inches='tight', dpi=300)