...
from groundtruth import sm3_fixed_points_1
unique_fixed_points_array = sm3_fixed_points_1
...
plt.ylim([0,1])
# plt.show()
plt.savefig('sm3_k=1.0_nf_fp_LGTNMx.pdf', bbox_inches='tight', dpi=300)