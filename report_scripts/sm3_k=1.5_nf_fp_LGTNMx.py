...
# plot.
ax.imshow(colour_grid, origin = 'lower', extent=(0, 1, 0, 1))
##################################################################################################################
##################################################################################################################
...
square = Rectangle((0.4, 0.4), 0.2, 0.2, fill = False)
...
ax.set_ylim([0,1])
# plt.show()
plt.savefig('sm3_k=1.5_nf_fp_LGTNMx.png', bbox_inches='tight', dpi=300)